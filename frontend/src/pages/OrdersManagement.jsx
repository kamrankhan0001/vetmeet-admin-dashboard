...
// import ProductFormModal from './ProductsFormPage';
...
//     // Replace with actual invoice download implementation
//   };
...
//               <th className="py-2 px-4 border-b">Delivery Partner</th>
...
//                 <td className="py-2 px-4 border-b">{order.deliveryPartner || 'Unassigned'}</td>
